...
//Autores: Angel Lillo, Óscar de la Torre
...
+!checkFinalWinner(W1,W2,W3) : W1=draw & W2=draw <- -+finalWinner(W3). //Empate en el primer nivel, por lo tanto gana el jugador que ha ganado el segundo nivel

+!checkFinalWinner(W1,W2,W3) : (W1=W2 & W2=W3) | (W1=W2) | (W2=W3) | (W1=W3)  <- -+finalWinner(W1). //Ambos niveles han sido ganados por el mismo jugador y por tanto es el ganador del juego

+!checkFinalWinner(W1,W2,W3) : points(1,player1,PointsPlayer1Lvl1) & points(2,player1,PointsPlayer1Lvl2) & points(3,player1,PointsPlayer1Lvl3) & points(1,player2,PointsPlayer2Lvl1) & points(2,player2,PointsPlayer2Lvl2) & points(3,player2,PointsPlayer2Lvl3) & ((PointsPlayer1Lvl1+PointsPlayer1Lvl2+PointsPlayer1Lvl3) > (PointsPlayer2Lvl1+PointsPlayer2Lvl2+PointsPlayer2Lvl3)) <- -+finalWinner(player1). //Gana por total de puntos player1

+!checkFinalWinner(W1,W2,W3) : points(1,player1,PointsPlayer1Lvl1) & points(2,player1,PointsPlayer1Lvl2) & points(3,player1,PointsPlayer1Lvl3) & points(1,player2,PointsPlayer2Lvl1) & points(2,player2,PointsPlayer2Lvl2) & points(3,player2,PointsPlayer2Lvl3) & ((PointsPlayer2Lvl1+PointsPlayer2Lvl2+PointsPlayer2Lvl3) > (PointsPlayer1Lvl1+PointsPlayer1Lvl2+PointsPlayer1Lvl3)) <- -+finalWinner(player2). //Gana por total de puntos player2

+!checkFinalWinner(W1,W2,W3) <- .print("ERROR en !finalWinner").
...
+startGame : size(N) & partidas(P) <- //Este plan se ejecutarÃ¡ cuando el entorno le avise al terminar la generacion del tablero
...
+turnoTerminado(Player) : level(L) & L=3 & (limitPoints(3,LimitPoints)  & points(L,Player,Points) & Points>=LimitPoints) | (jugadasRestantes(N) & N=0) |  (jugadasPlayer(Player,J) & J>=50) | (celdas(Player,C) & C=100) <- //Final del Nivel 3
					.print("Alcanzado el numero maximo de puntos en el Nivel 3 o dominio total de las celdas");
					!showPoints;
					!showCeldas;
					!checkLevelWinner;
...
+!showCeldas : celdas(player1,C1) & celdas(player2,C2) <-	.print("Celdas:  Player 1 -> ",C1,"  //  Player 2 -> ",C2).
